...
const registrar = async (req, res) => {
    ...
    const existeUsuario = await Veterinario.findOne({email}); // Buscar por el atributo que le indiquemos
...
const confirmar = async (req, res) => {
    // Las variables de la url se leen con req.params
...
const actualizarPassword = async (req, res) => {
    ...
    // Comprobar q exista el veterinario
